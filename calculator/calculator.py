...
btnTanh = Button(calc,text="tan", width=6, height=2,font=('arial',20,'bold'),bd=4,bg="powder blue",
command= added_value.tanh).grid(row=1,column=6,pady=1)

btnSinh = Button(calc,text="sin", width=6, height=2,font=('arial',20,'bold'),bd=4, bg="powder blue",
...
lblDisplay=Label(calc,text="my python calculator",font=('arial',30,'bold'),justify=CENTER)
